...
export function meta() {
  return [
    { title: "Discord 설치하기 | GAMEMOA Wiki" },
    { name: "description", content: "GAMEMOA Discord 앱을 서버에 설치하는 방법" },
  ];
}
...
export default function WikiDiscordInstallRoute() {
  ...
  return (
    <WikiLayout
      eyebrow="DISCORD"
      title="Discord에 GAMEMOA 설치하기"
      description="Discord 앱 설치는 GAMEMOA를 서버에서 사용할 준비 단계입니다. 서버 등록과는 별개입니다."
    >
      <WikiCallout>
      ...
      <WikiCallout tone="warning">
        <b className="text-text-primary">앱 설치 ≠ GAMEMOA 서버 등록입니다.</b> 앱을 설치해도 서버가
        자동으로 GAMEMOA 디렉토리에 게시되지 않습니다. 관리자가{" "}
        <Link
