...
마이그레이션별 전체 컬럼 목록과 Phase F/G/H1/H2 구축 서사는
[`docs/archive/discord-integration-phase-history.md`](archive/discord-integration-phase-history.md)에
보존되어 있습니다. 설치/설정/명령어 등록/장애 해결 절차는
[`docs/runbooks/discord-bot-ops.md`](runbooks/discord-bot-ops.md) 참고.
