...
test("Creator score ranking binds game IDs instead of interpolating query input", async () => {
  ...
  await new D1CreatorRepository(db).getCreatorRankings({ mode: "score", gameId: injected });
