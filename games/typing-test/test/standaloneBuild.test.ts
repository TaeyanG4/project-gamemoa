 ...
 * version-hashed path (official-games/typing-test/<hash>/, see gameServing.ts). Runs vite's own JS
...
test("standalone build produces a relative-path index.html plus JS/CSS bundle assets", async () => {
  ...
  // Relative, not absolute — this bundle is served from official-games/typing-test/<hash>/,
